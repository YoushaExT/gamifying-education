...
export class MultiplayerGameService {
     ...
     * @throws ApiError
     */
    public static getRandomQuestionForGame(data: MultiplayerGameGetRandomQuestionForGameData): CancelablePromise<MultiplayerGameGetRandomQuestionForGameResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/multiplayer/games/{game_id}/random-question',
            path: {
                game_id: data.gameId
            },
            errors: {
